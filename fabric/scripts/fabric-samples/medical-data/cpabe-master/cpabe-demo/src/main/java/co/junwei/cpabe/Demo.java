...
//		String student2_attr = "cn:student2 uid:student2 title:student"; //high + medium
...
//		println("//start to keygen");
		String priKey = test.keygen(pubfile, prvfile, mskfile, student_attr);
//		test.keygen(pubfile, prvfile2, mskfile, student2_attr);
//		println("//end to keygen");

//		println("//start to enc");
		long start = System.currentTimeMillis();
		String encKey = test.enc2(pubfile, policy, highInputfile, mediumInputfile, highEncfile, mediumEncfile);
...
//		test.dec2(pubfile, prvfile2, highEncfile, mediumEncfile, highDecfile_user2, mediumDecfile_user2, encKey);
//		println("//end to dec");
	}
